...
public class ForgeSpawnEggItem extends SpawnEggItem {
    ...
    protected static final List<ForgeSpawnEggItem> EGGS_TO_ADD = new ArrayList<>();
    ...
    public ForgeSpawnEggItem(final RegistryObject<? extends EntityType<?>> entity, final int primaryColor,
